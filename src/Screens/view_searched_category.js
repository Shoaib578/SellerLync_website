...
class ViewSearchedCategory extends React.Component {
  state = {
    all_vendors: [],
    category_info:[]
  }
  ...
  Axios.get(base_url+'view_searched_category?category_id='+this.props.match.params.id+'&&location='+this.props.match.params.location)
  .then(res=>{
...
export default ViewSearchedCategory